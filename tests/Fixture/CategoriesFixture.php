...
class CategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cat_name' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_at' => '2020-04-28 21:09:48',
                'modified_at' => '2020-04-28 21:09:48',
            ],
        ];
        parent::init();
    }
